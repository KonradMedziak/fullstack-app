...
import com.example.pasir_medziak_konrad.dto.GroupResponseDTO;
import com.example.pasir_medziak_konrad.dto.MembershipResponseDTO;
...
import com.example.pasir_medziak_konrad.service.MembershipService;
...
public class MembershipGraphQLController {
    ...
    public List<MembershipResponseDTO> groupMembers(@Argument Long groupId) {
        ...
        return membershipRepository.findByGroupId(group.getId()).stream().map(
    ...
    public List<GroupResponseDTO> myGroups() {
        ...
        return groupRepository.findByMemberships_User(user).stream().map(
