...
import com.example.pasir_medziak_konrad.security.JwtUtil;
...
public class UserService implements UserDetailsService {
    ...
    public String login(LoginDto dto) {
        User user = userRepository.findByEmail(dto.getEmail()).orElseThrow(() -> new UsernameNotFoundException("Nie znaleziono użytkownika"));
